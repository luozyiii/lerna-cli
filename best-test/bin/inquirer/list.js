...
class List extends EventEmitter {
  ...
  getContent = () => {
    if (!this.haveSelected) {
      let title = '\x1B[32m?\x1B[39m \x1B[1m' + this.message + '\x1B[22m\x1B[0m\x1B[0m\x1B[2m' + '(Use arrow keys)\n';
      ...
      let title = '\x1B[32m?\x1B[39m \x1B[1m' + this.message + '\x1B[22\x1B[0m\x1B[36m' + name + '\x1B[39\x1B[0m \n';
      return title;
    }
  };
